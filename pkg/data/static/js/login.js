...
function goHome(params) {
    console.log("进入connect.html 页面")
    document.querySelector(".login").style.display = "none"
    document.querySelector("#barshow-select").style.display = "block"
...
$("#close_connection_window").on("click",function(){
    ...
    document.querySelector("#databases").style.display = "none"
    swdbname = null
});
